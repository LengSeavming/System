...
export class FilterPetComponent implements OnInit, OnDestroy {
    ...
    constructor(
        ...
        private dialogRef: MatDialogRef<FilterPetComponent>,
    ...
    submit(): void {
        if (this.filterForm.valid) {
            ...
            if (formValue.timeType !== 'startandend') {
                ...
                formValue.startDate = this.formatDateToISOString(
                    formValue.startDate
                );
                formValue.endDate = this.formatDateToISOString(
                    formValue.endDate
                );
            }
