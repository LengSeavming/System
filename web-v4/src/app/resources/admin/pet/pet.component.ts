...
import { Data, List, PetType, User } from './pet.types';
import { PetTypeDialogComponent } from './type/dialog/component';
import { FilterPetComponent } from './filter/component';
import { ViewDetailPetComponent } from './view/view.component';
import { PetDialogComponent } from './dialog/component';
...
export class PetComponent implements OnInit {
    ...
    setup: { petType: PetType[]; users: User[] } = {
        petType: [],
        users: [],
    };
    petType: PetType[] = [];
    ...
    initSetup(): void {
        this.petService.setup().subscribe({
            next: (response) => {
    ...
    list(
        ...
        this.isLoading = true;
        this.petService.list(params).subscribe({
            next: (res: List) => {
    ...
    openFilterDialog(): void {
        ...
        const dialogRef = this.dialog.open(FilterPetComponent, dialogConfig);
    ...
    create(): void {
        ...
        const dialogRef = this.matDialog.open(PetDialogComponent, dialogConfig);
    ...
    update(row: Data): void {
        ...
        dialogRef.componentInstance.ResponseData.subscribe((pet: Data) => {
    ...
    getReport() {
        this.saving = true;
        this.petService.getDataPetReport().subscribe({
            next: (response) => {
                this.saving = false;
    ...
    onDelete(product: Data): void {
        ...
        dialogRef.afterClosed().subscribe((result: string) => {
            if (
                ...
                this.petService.delete(product.id).subscribe({
